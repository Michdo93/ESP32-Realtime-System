...
def fall_recognition(lock, csi_amplitude_array, csi_shape, result_lock, action_array,
                     model_path=r"F:\SRIBD\ESP32-Realtime-System\Falldataset_20240225\dataset_20240225.pth",
                     task_action=3):
...
def fall_recognition_plot(action_array, task_action=3):
    ...
    bar_action = ax1.bar(action_name, action_arr)  # Create bar chart
